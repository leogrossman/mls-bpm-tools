...
- Dedicated TBT raw logging control window limits the touched BPM set, previews exact writes, checks current `.SCAN` state, suggests a small SSMB burst-study BPM set, and supports timed auto-stop.
